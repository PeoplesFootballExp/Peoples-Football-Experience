...
2. Clone repo into a local folder
   ```
   git clone https://github.com/PeoplesFootballExp/Peoples-Football-Experience.git
   ```
...
- Open or discuss ideas
- Check out the #dev-updates and #feature-ideas channels for current priorities

### Contribution Flow
1. Fork the repository
2. Create a new branch (feature/your_feature)
